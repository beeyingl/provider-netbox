...
func (tr *Resource) GetParameters() (map[string]interface{}, error) {
	...
	p, err := json.TFParser.Marshal(GetObject(tr.GetTerraformResourceType(), tr.Spec.ForProvider.Raw))
	if err != nil {
		return nil, err
	}
	base := map[string]interface{}{}
